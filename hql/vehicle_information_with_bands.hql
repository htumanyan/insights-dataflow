...
select 
     ...
     CASE WHEN VI.stockage/7 >=0 AND VI.stockage/7 <7 THEN '< 1 '
      ...
      CASE WHEN VI.totaldamagesnetprice >=0 AND VI.totaldamagesnetprice <99 THEN '<100'
           ...
           WHEN VI.totaldamagesnetprice >=501 AND VI.totaldamagesnetprice <750 THEN '501 - 750'
           WHEN VI.totaldamagesnetprice >=751 AND VI.totaldamagesnetprice <100000 THEN '> 750'
      end as damagesBandName,
      case WHEN VI.totaldamagesnetprice >=0 AND VI.totaldamagesnetprice <99 THEN 0
           WHEN VI.totaldamagesnetprice >=100 AND VI.totaldamagesnetprice <500 THEN 1
           WHEN VI.totaldamagesnetprice >=501 AND VI.totaldamagesnetprice <750 THEN 2
           WHEN VI.totaldamagesnetprice >=751 AND VI.totaldamagesnetprice <100000 THEN 3
      end as damagesBandId,
     case WHEN VI.mileage >=0 AND VI.mileage <10000 THEN '0-10 000'
          WHEN VI.mileage >=10001 AND VI.mileage <20000 THEN '10 001-20 000'
          WHEN VI.mileage >=20001 AND VI.mileage <30000 THEN '20 001-30 000'
          WHEN VI.mileage >=30001 AND VI.mileage <40000 THEN '30 001-40 000'
          ...
          WHEN VI.mileage >=100001 AND VI.mileage <150000 THEN '100 001-150 000'
          WHEN VI.mileage >=150001 AND VI.mileage <999999 THEN '> 150 000'
      end mileageBandName,
    case
            WHEN VI.mileage >=0 AND VI.mileage <10000 THEN 0
            WHEN VI.mileage >=10001 AND VI.mileage <20000 THEN 1
            WHEN VI.mileage >=20001 AND VI.mileage <30000 THEN 2
            WHEN VI.mileage >=30001 AND VI.mileage <40000 THEN 3
