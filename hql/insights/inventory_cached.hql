...
coalesce(cc.division_name, vdmv.vb_make, case when v.make='null' then NULL else v.make end) as make,
coalesce(cc.division_name, vdmv.vb_make, case when v.make='null' then NULL else v.make end) as makeref,
 0 as salechannelid,
  'none' as salechannel,
