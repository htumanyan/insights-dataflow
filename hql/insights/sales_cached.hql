...
coalesce(c.best_make_name, vdmv.vb_make,  case when v.make='null' then NULL else v.make end, mmr.mmr_make) as makeref,
 'n/a' as registration,
 'n/a' as chassis,
coalesce(c.best_trim_name, c.trim_name, v.trim_level) as derivative,
abs(hash(coalesce(c.best_trim_name, c.trim_name, v.trim_level))) as derivativeid,
...
coalesce(c.fuel_type, AV.fuel_type) as fueltype,
V.id as vehicleid, 
 V.vin,
0 as sourceid,
'n/a' as sourcename, 
