...
CREATE TABLE chrome.chrome_consolidated
AS
SELECT 
 vd.input_row_num,
 s.passthru_id,
...
from chrome.vehicle_description vd 
 left JOIN chrome.body_type as bt ON (bt.input_row_num= vd.input_row_num)
 left JOIN chrome.engine as e ON e.input_row_num = bt.input_row_num 
